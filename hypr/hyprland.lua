...
hl.monitor({
	output = "desc:BVR DCM5-R S11PR20260206",
	mode = "preferred",
	position = "auto-right",
	scale = "1",
})
...
hl.monitor({
	output = "desc:BVL DCM5-L S11PL20260206",
	mode = "preferred",
	position = "auto-left",
	scale = "1",
})
...
hl.on("hyprland.start", function()
	hl.exec_cmd("awww-daemon & aww img /home/Eoin/.config/hypr/wallpapers/wallpaper.jpg")
	hl.exec_cmd("nm-applet & kdeconnect-indicator")
	hl.exec_cmd("uv --project ~/.config/fabric-shell run -m fabric_shell.bar.config & hypridle & swaync")
end)
...
hl.config({
	...
	decoration = {
		...
		screen_shader = "/home/Eoin/.config/hypr/color_fix.frag",
	},
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4, bezier = "easeOutQuint", style = "slide 87%" })
...
hl.animation({ leaf = "layersOut", enabled = true, speed = 3, bezier = "swift", style = "fade" })
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("departure"))
...
hl.bind(mainMod .. "+ SHIFT + L", hl.dsp.exec_cmd("firefox"))
